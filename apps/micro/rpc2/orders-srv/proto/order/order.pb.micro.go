...
type OrdersService interface {
	New(ctx context.Context, in *OrderRequest, opts ...client.CallOption) (*OrderResponse, error)
...
func (c *ordersService) New(ctx context.Context, in *OrderRequest, opts ...client.CallOption) (*OrderResponse, error) {
...
func (c *ordersService) GetOrder(ctx context.Context, in *OrderRequest, opts ...client.CallOption) (*OrderResponse, error) {
...
type OrdersHandler interface {
	New(context.Context, *OrderRequest, *OrderResponse) error
...
func RegisterOrdersHandler(s server.Server, hdlr OrdersHandler, opts ...server.HandlerOption) error {
	type orders interface {
		New(ctx context.Context, in *OrderRequest, out *OrderResponse) error
...
func (h *ordersHandler) New(ctx context.Context, in *OrderRequest, out *OrderResponse) error {
	return h.OrdersHandler.New(ctx, in, out)
}

func (h *ordersHandler) GetOrder(ctx context.Context, in *OrderRequest, out *OrderResponse) error {
